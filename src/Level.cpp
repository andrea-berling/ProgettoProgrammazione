...
#if 0
    if (mons.isAwake() && (POS.x != tmpp.x-1 || POS.y != tmpp.y-1)){ // Non c'e' bisogno del controllo sul awake se
        //chiami il metodo solo su mostri svegli
#endif
